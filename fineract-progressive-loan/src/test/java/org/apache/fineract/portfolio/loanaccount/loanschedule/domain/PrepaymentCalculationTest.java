...
public class PrepaymentCalculationTest {
    ...
    public void setUp() {
        ...
        MONEY_HELPER.when(MoneyHelper::getMathContext).thenReturn(new MathContext(12, RoundingMode.UP));
        MONEY_HELPER.when(MoneyHelper::getRoundingMode).thenReturn(RoundingMode.UP);
